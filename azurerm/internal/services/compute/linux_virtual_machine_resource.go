...
func resourceLinuxVirtualMachineRead(d *schema.ResourceData, meta interface{}) error {
	...
	// TODO: once Dedicated Hosts are supported - read them here
	//dedicatedHostId := ""
	...
	connectionInfo := retrieveConnectionInformation(ctx, networkInterfacesClient, resp.VirtualMachineProperties)
